...
ax1.plot(date, avg_t_b, linewidth=1, marker='.', label='Turin C2G')
ax1.plot(date, avg_p_b, linewidth=1, marker='^', label='Portland C2G')
ax1.plot(date, avg_te_b, linewidth=1, marker='*', label='Turin Enjoy')
...
#df = df.set_index('date')
ax2.plot(date, std_p_b, linewidth=1, marker='.', label='Portland C2G')
ax2.plot(date, std_te_b, linewidth=1, marker='^', label='Turin C2G')
ax2.plot(date, std_te_b, linewidth=1, marker='*', label='Turin Enjoy')
...
#df = df.set_index('date')
ax3.plot(date, to_median, linewidth=1, marker='.', label='Turin C2G')
ax3.plot(date, eto_media, linewidth=1, marker='^', label='Turin Enjoy')
ax3.plot(date, po_media, linewidth=1, marker='*', label='Portland C2G')
...
ax4.plot(date, to_per, linewidth=1, marker='.', label='Turin C2G')
ax4.plot(date, po_per, linewidth=1, marker='^', label='Portland C2G')
ax4.plot(date, eto_per, linewidth=1, marker='*', label='Turin Enjoy')

ax4.fmt_xdata = mdates.DateFormatter('%Y-%m-%d')
ax4.set_title('Percentile 75%')
ax4.legend(bbox_to_anchor=(1.05, 4.), loc='upper left',
          borderaxespad=0.)
ax4.grid(linestyle='--', linewidth=.4, which="both")
ax4.set_ylim(3, 60)
plt.subplots_adjust(bottom=0.3, right=0.8, top=0.9, hspace=1)
plt.savefig(fname="../plots/Book_stats_2.png")
plt.close()
...
ax1.plot(date, avg_t_p, linewidth=1, marker='.', label='Turin C2G')
ax1.plot(date, avg_te_p, linewidth=1, marker='^', label='Turin Enjoy')
ax1.plot(date, avg_p_p, linewidth=1, marker='*', label='Portland C2G')
...
#df = df.set_index('date')
ax2.plot(date, std_t_p, linewidth=1, marker='.', label='Turin C2G')
ax2.plot(date, std_te_p, linewidth=1, marker='^', label='Turin Enjoy')
ax2.plot(date, std_p_p, linewidth=1, marker='*', label='Portland C2G')
...
ax4.grid(linestyle='--', linewidth=.4, which="both")
plt.subplots_adjust(bottom=0.3, right=0.8, top=0.9, hspace=1)
plt.savefig(fname="../plots/Park_stats_2.png")
plt.close()